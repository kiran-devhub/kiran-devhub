...
```typescript
const kiran = {
  title: "Full Stack Developer | Secure Web Applications | Cybersecurity",
  stack: {
    languages: ["JavaScript (ES6+)", "TypeScript", "Python", "Java", "C/C++"],
    frontend: ["React", "Next.js", "HTML5", "CSS3", "Tailwind CSS"],
    backend: ["Node.js", "Express.js", "REST APIs", "JWT Authentication", "Clerk Authentication"],
  ...
  certifications: "adding soon 📄",
  status: "Building secure, full-stack web apps & leveling up cybersecurity skills",
  openTo: [
